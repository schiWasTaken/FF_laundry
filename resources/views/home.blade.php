    ...
    <div class="container">
        ...
        <div class="services-container">
            <div class="service-card">
                ...
                <h3>Cuci dan Seterika</h3>
                <p>Layanan cuci, kering, seterika dan lipat.</p>
                <!-- Button to Open the Modal -->
                <div class="service-actions">
                    <button type="button" class="btn btn-primary selectServiceButton" data-bs-toggle="modal"
                        data-bs-target="#service1Modal" data-service="1">
                        Select
                    </button>
                </div>
            </div>
            <div class="service-card">
                ...
                <h3>Hanya Seterika</h3>
                <p>Layanan seterika dan lipat.</p>
                <!-- Button to Open the Modal -->
                <div class="service-actions">
                    <button type="button" class="btn btn-primary selectServiceButton" data-bs-toggle="modal"
                        data-bs-target="#service2Modal" data-service="2">
                        Select
                    </button>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 me-auto">
                  <p class="lead">Bagaimana memaksimalkan waktu liburan atau rutinitas penting harian tanpa terganggu oleh pekerjaan tambahan dirumah. Sangatlah penting saat melakukan rutinitas penting atau liburan tanpa khawatir akan ketersediaan pakaian bersih selama dalam perjalanan sehingga liburan semakin berkesan dan menyenangkan.</p>
            </div>
        </div>
